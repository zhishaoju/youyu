...
import static com.youyu.gao.xiao.utils.Contants.VIDEO_DURATION_SETTING_MAX;
import static com.youyu.gao.xiao.utils.Contants.VIDEO_DURATION_SETTING_MIN;
...
import com.youyu.gao.xiao.adapter.PosIdArrayAdapter;
import com.youyu.gao.xiao.utils.PositionId;
...
public class UnifiedInterstitialFullScreenADActivity extends Activity implements OnClickListener,
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    arrayAdapter = new PosIdArrayAdapter(this, android.R.layout.simple_spinner_item,
        getResources().getStringArray(R.array.unified_interstitial_video));
