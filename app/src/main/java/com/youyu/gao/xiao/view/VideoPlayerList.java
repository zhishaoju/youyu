package com.youyu.gao.xiao.view;
 ...
 * des ：对于视频播放界面的一个封装类 gitVersion：2.12.0.windows.1 updateAuthor：AllenIverson updateDate：2017/5/24
 * 18:05 updateDes：${TODO} ============================================================
 */

public class VideoPlayerList extends RelativeLayout {

  private static final String TAG = "VideoPlayer";
  @BindView(R.id.video_view)
  public TextureView videoView;
  @BindView(R.id.mediaController)
  public VideoMediaControllerList mediaController;
  ...
  public VideoPlayerList(Context context, AttributeSet attrs) {
    this(context, attrs, 0);
  }

  public VideoPlayerList(Context context, AttributeSet attrs, int defStyleAttr) {
  ...
  private void initView() {
    View view = View.inflate(getContext(), R.layout.video_play_list, this);
...
//      mSurfaceHolder = mSurface.
  ...
  private MediaPlayer.OnErrorListener onErrorListener = new MediaPlayer.OnErrorListener() {
    ...
    public boolean onError(MediaPlayer mp, int what, int extra) {
      mPlayer.reset();
      LogUtil.showDLog(TAG, "mp = " + mp);
      LogUtil.showDLog(TAG, "what = " + what);
      LogUtil.showDLog(TAG, "extra = " + extra);
