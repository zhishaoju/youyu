 ...
 * @author 陈靖
 */
public class TaskPullToRefreshLayout extends RelativeLayout {
    ...
    public TaskPullToRefreshLayout(Context context) {
        super(context);
        initView(context);
    }

    public TaskPullToRefreshLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }

    public TaskPullToRefreshLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    private class AutoRefreshAndLoadTask extends
        ...
        protected void onPostExecute(String result) {
            ...
            // 刷新操作
            if (mListener != null)
                mListener.onRefresh(TaskPullToRefreshLayout.this);
            hide();
        }
    ...
    public interface OnRefreshListener {
         ...
         * 刷新操作
         */
        void onRefresh(TaskPullToRefreshLayout pullToRefreshLayout);

        /**
         * 加载操作
         */
        void onLoadMore(TaskPullToRefreshLayout pullToRefreshLayout);
    }
